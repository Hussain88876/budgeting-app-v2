...
export default function Form({ categories }: { categories: CategoryField[] }) {
  ...
  // Assuming createTransaction accepts (state, payload) signature compatible with useFormState
  // Use `any` casting if Type mismatches due to Server Action signature constraints in this setup
